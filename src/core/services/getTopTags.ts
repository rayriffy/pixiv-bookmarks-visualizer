...
import type { TagSearchResponse } from '../@types/api/TagSearchResponse'
...
export const getTopTags = async (
  ...
  async function getTagCountsForBatch(
    illustIds: number[]
  ...
  const tagResultsBatches = await batchedQuery(
    illustsToAnalyze,
    getTagCountsForBatch
  )
