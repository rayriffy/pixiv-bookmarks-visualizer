...
export const BookmarkType = () => {
    ...
    const [togglePublic, setTogglePublic] = useState(restriction === "public" || restriction === "all");
    const [togglePrivate, setTogglePrivate] = useState(restriction === "private" || restriction === "all");
